...
using ExclusiveCarsWAndW.Core.ProjectAggregate.Events;
using ExclusiveCarsWAndW.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace ExclusiveCarsWAndW.UnitTests.Core.Handlers;
