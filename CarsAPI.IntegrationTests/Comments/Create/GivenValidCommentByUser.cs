...
public class GivenValidCommentByUser : IClassFixture<TestFixture>
{
    private readonly TestFixture _fixture;

    public GivenValidCommentByUser(TestFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task ThenResponseIsCreatedAndCommentIsAddedToDatabase()
    {
        ...
        var userToken = await _fixture.ApiClient.GetUserToken();
